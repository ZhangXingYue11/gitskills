    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <!-- 这里这样给数据不行 因为如果skuInfo没有返回数据 则是undefined -->
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前咱们的路由跳转 只是单纯从a路由跳转到b 这里在跳转之前 发请求将购买信息发请求通知服务器 进行存储 -->
...
export default {
  ...
  methods: {
    ...
    async addShopcar() {
      ...
      // 3：失败 给用户提示
      // 4：在路由跳转的时候还需要将产品的信息带给下一级路由
      // 下面这行代码 调用仓库函数 这个方法加上asyc 返回的一定是一个promise对象 要么成功要么失败
      try {
